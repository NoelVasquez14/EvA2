  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div align="center" >  <h1 aling="center" style="color: white "  >Listado de actividades</h1> </div>
        <h2  style="color: red"> NOTA: DE ESTS TABLA SOLO SE PUEDE VISUALIZAR Y ELIMINAR POR EL MOMENTO </h2>
        <p>
